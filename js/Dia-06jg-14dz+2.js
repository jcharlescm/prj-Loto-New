...
function carregaNE02() {
  document.frm.JG61.value = document.frm.NE02.value;
...
function carregaNE03() {
  document.frm.JG12.value = document.frm.NE03.value;
  document.frm.JG54.value = document.frm.NE03.value;
  document.frm.JG63.value = document.frm.NE03.value;
}
...
function carregaNE04() {
  document.frm.JG13.value = document.frm.NE04.value;
  document.frm.JG22.value = document.frm.NE04.value;
...
function carregaNE05() {
  document.frm.JG14.value = document.frm.NE05.value;
...
function carregaNE06() {
  document.frm.JG24.value = document.frm.NE06.value;
  document.frm.JG33.value = document.frm.NE06.value;
  document.frm.JG42.value = document.frm.NE06.value;
}
...
function carregaNE07() {
  ...
  document.frm.JG43.value = document.frm.NE07.value;
  document.frm.JG52.value = document.frm.NE07.value;
}
...
function carregaNE08() {
  document.frm.JG44.value = document.frm.NE08.value;
  document.frm.JG53.value = document.frm.NE08.value;
...
function carregaNE09() {
  document.frm.JG15.value = document.frm.NE09.value;
  document.frm.JG57.value = document.frm.NE09.value;
  document.frm.JG66.value = document.frm.NE09.value;
}
...
function carregaNE10() {
  document.frm.JG16.value = document.frm.NE10.value;
  document.frm.JG25.value = document.frm.NE10.value;
  document.frm.JG67.value = document.frm.NE10.value;
}
...
function carregaNE11() {
  document.frm.JG17.value = document.frm.NE11.value;
...
function carregaNE12() {
  document.frm.JG27.value = document.frm.NE12.value;
  document.frm.JG36.value = document.frm.NE12.value;
  document.frm.JG45.value = document.frm.NE12.value;
}
...
function carregaNE13() {
  ...
  document.frm.JG55.value = document.frm.NE13.value;
}
...
function carregaNE14() {
  document.frm.JG47.value = document.frm.NE14.value;
  document.frm.JG56.value = document.frm.NE14.value;
  document.frm.JG65.value = document.frm.NE14.value;
}
