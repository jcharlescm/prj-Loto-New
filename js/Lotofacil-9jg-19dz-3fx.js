...
console.log(escreveJogos);
  ...
  function soma() {       
      ...
      total03 = parseFloat(0 + document.frm.JG0301.value) + parseFloat(0 + document.frm.JG0302.value) + parseFloat(0 + document.frm.JG0303.value) + parseFloat(0 + document.frm.JG0304.value) + parseFloat(0 + document.frm.JG0305.value) + parseFloat(0 + document.frm.JG0306.value) + parseFloat(0 + document.frm.JG0307.value) + parseFloat(0 + document.frm.JG0308.value) + parseFloat(0 + document.frm.JG0309.value) + parseFloat(0 + document.frm.JG0310.value) + parseFloat(0 + document.frm.JG0311.value) + parseFloat(0 + document.frm.JG0312.value) + parseFloat(0 + document.frm.JG0313.value) + parseFloat(0 + document.frm.JG0314.value) + parseFloat(0 + document.frm.JG0315.value);
  ...
  function carregaNE04() {
      ...
      document.frm.JG0306.value = document.frm.NE04.value;
      document.frm.JG0405.value = document.frm.NE04.value;
      document.frm.JG0504.value = document.frm.NE04.value;
      document.frm.JG0604.value = document.frm.NE04.value;
      document.frm.JG0812.value = document.frm.NE04.value;
  ...
  function carregaNE05() {
      ...
      document.frm.JG0406.value = document.frm.NE05.value;
  ...
  function carregaNE06() {
    ...
    document.frm.JG0903.value = document.frm.NE06.value;
}
  ...
  function carregaNE07() {
      ...
      document.frm.JG0904.value = document.frm.NE07.value;     
}
  ...
  function carregaNE08() {
    ...
    document.frm.JG0309.value = document.frm.NE08.value;
    document.frm.JG0408.value = document.frm.NE08.value;
    document.frm.JG0508.value = document.frm.NE08.value;
    document.frm.JG0704.value = document.frm.NE08.value;
    document.frm.JG0905.value = document.frm.NE08.value;
  }
  ...
  function carregaNE09() {
    ...
    document.frm.JG0207.value = document.frm.NE09.value;
    document.frm.JG0409.value = document.frm.NE09.value;
    document.frm.JG0509.value = document.frm.NE09.value;
    document.frm.JG0705.value = document.frm.NE09.value;
    document.frm.JG0806.value = document.frm.NE09.value;
    document.frm.JG0906.value = document.frm.NE09.value;      
  }
  ...
  function carregaNE10() {	
      document.frm.JG0109.value = document.frm.NE10.value;
      document.frm.JG0208.value = document.frm.NE10.value;
      document.frm.JG0307.value = document.frm.NE10.value;
      document.frm.JG0510.value = document.frm.NE10.value;
      document.frm.JG0706.value = document.frm.NE10.value;
      document.frm.JG0807.value = document.frm.NE10.value;
      document.frm.JG0907.value = document.frm.NE10.value;
  }
  ...
  function carregaNE11() {
      ...
      document.frm.JG0308.value = document.frm.NE11.value;
      document.frm.JG0407.value = document.frm.NE11.value;
      document.frm.JG0511.value = document.frm.NE11.value;
      document.frm.JG0707.value = document.frm.NE11.value;
      document.frm.JG0813.value = document.frm.NE11.value;
      document.frm.JG0908.value = document.frm.NE11.value;
  }
